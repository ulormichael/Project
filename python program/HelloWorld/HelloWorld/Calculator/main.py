...
class CurvedEdgesBoxLayout(BoxLayout):
    def __init__(self, **kwargs):
        super(CurvedEdgesBoxLayout, self).__init__(**kwargs)
...
class MainApp(App):
    def build(self):
        ...
        main_layout = CurvedEdgesBoxLayout(orientation="vertical")
